...
\lfoot{\footnotesize Thibaut EHLINGER et Benjamin HERB \textbullet ~ OS embarqués}
\cfoot{}
...
\title{OS embarqués : projet}					% Title of your article goes here
...
Pour information, notre sous-réseau a pour adresse IPv6 : \texttt{2001:660:4701:f0a6/64}. Notre \textit{border-router} est le nœud numéro \textbf{m3-2}. Pour déployer notre réseau nous avons dû :
\begin{enumerate}
\item
\end{enumerate}
